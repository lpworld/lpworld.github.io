...
* [2] Hybrid Utility Function for Unexpected Recommendations
  * **Pan Li**
  * Proceedings of the 13th International Conference on Web Search and Data Mining (WSDM 2020)
  * Doctoral Consortium

* [3] Towards Controllable and Personalized Review Generation
  * **Pan Li**, Alexander Tuzhilin
...
* [4] Latent Multi-Criteria Ratings for Recommendations
  * **Pan Li**, Alexander Tuzhilin
  * Proceedings of the 13th ACM Conference on Recommender Systems (RecSys 2019)
  * Acceptance Rate: 40/165=24.2% (Short Paper)
  
* [5] Latent Modeling of Unexpectedness for Recommendations
  * **Pan Li**, Alexander Tuzhilin
  * Proceedings of the 13th ACM Conference on Recommender Systems (RecSys 2019)
  * Acceptance Rate: 13/42=31.0\% (Late-Breaking Result Track)

* [6] Measuring the popularity of job skills in recruitment market: A multi-criteria approach
